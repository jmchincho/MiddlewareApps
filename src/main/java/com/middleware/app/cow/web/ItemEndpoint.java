...
public class ItemEndpoint {
    ...
    public Response findAll(Integer index, Integer totalCount) {
        try {
            return Response.ok().entity(itemService.find(index, totalCount, null)).build();
    ...
    @GET
    public Response findAllByFilter(Integer index, Integer totalCount, Item item) {
        try {
            return Response.ok().entity(itemService.find(index, totalCount, item)).build();
        } catch (CowException e) {
            return Response.serverError().build();
        }
    }
